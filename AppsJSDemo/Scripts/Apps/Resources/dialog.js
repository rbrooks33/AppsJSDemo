    ...
    var Me = {
        ...
        Register: function (elementId, className, templateId) {
            ...
            if (!exists.Success) {
                ...
                Apps.$(document.forms[0]).append("<div" + attributes + "></div>");
        ...
        Register2: function (id, settings) {
            ...
            if (!exists.Success) {
                ...
                if (settings.container)
                    ...
                    Apps.$(document.body).append("<div" + attributes + "></div>");

                newDialog.Selector = Apps.$("#" + id);
        ...
        DragDrop: function (dialogId, event) {
            ...
            Apps.$('#' + dialogId).css("left", (event.clientX - 120) + 'px').css('top', (event.clientY - 300) + 'px');
        ...
        Open: function (elementId, x, y) {
            ...
            if (dialogs.length === 1) {
                ...
                if (Me.Opened) {
                    ...
                    Apps.$("#" + elementId).fadeIn("slow"); //.animate({ width: '70%', marginLeft: "0.6in" }, 1500); //("slow").css({ top: y + "px", left: x + "px" });
        ...
        CloseAll: function () {
            Apps.$.each(Me.Dialogs, function (index, dialog) {
                Me.Close(dialog.ElementID);
            });

        },
        Refresh: function (dialog) {
            var windowWidth = Apps.$(window).width();
            var windowHeight = Apps.$(window).height();
